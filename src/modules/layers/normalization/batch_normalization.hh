...
namespace aurelius
{
    namespace normalization
    {
        ...
        public:
            ...
            Eigen::MatrixXf get_gamma() const { return gamma; }
            Eigen::MatrixXf get_beta() const { return beta; }
            Eigen::MatrixXf get_mean() const { return mean; }
            Eigen::MatrixXf get_variance() const { return variance; }
